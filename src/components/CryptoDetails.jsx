...
const CryptoDetails = () => {
  ...
  const refCurId = 'yhjMzLPhuIDl';
  console.log(coinId,refCurId, timePeriod);
  const { data: coinHistory  } = useGetCryptoHistoryQuery({coinId,refCurId, timePeriod});
        ...
        <Col className='coin-links'>
              ...
              {cryptoDetails.links.map((link) => (
                <Row className='coin-link' key={link.name}>
                      ...
                      <a href={link.url} target="_blank" rel="no">
                            {link.name}
                      </a>
                </Row>
              ))}
